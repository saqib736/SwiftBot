...
#define MOTOR_POWER_MEASURED_VOLTAGE 12.2     // current voltage reading of the power connected to the motor (used for calibration)
#define COUNTS_PER_REV1 2410              // wheel1 encoder's no of ticks per rev
#define COUNTS_PER_REV2 2452              // wheel2 encoder's no of ticks per rev
#define COUNTS_PER_REV3 2369              // wheel3 encoder's no of ticks per rev
#define COUNTS_PER_REV4 2327              // wheel4 encoder's no of ticks per rev
#define WHEEL_DIAMETER 0.043	            // wheel's diameter in meters
#define LR_WHEELS_DISTANCE 0.1588           // distance between left and right wheels
